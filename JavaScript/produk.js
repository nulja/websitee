const hamburger = document.querySelector('.hamburger');
        ...
        function openPopup(button) {
            const productCard = button.closest('.product-card'); // Ambil elemen parent terdekat
            if (!productCard) {
            ...
            const title = titleElement.innerText.trim(); // Menghindari spasi berlebih
            ...
            // Debugging untuk memastikan nilai title, imageSrc, dan price
            console.log("🔎 Title:", title);
            console.log("🖼️ Image Source:", imageSrc);
            console.log("💰 Price:", price);
        
            // Tentukan deskripsi berdasarkan produk
            let description = "";
            if (title.includes("KASTURI'QU")) {
                ...
                description = "RAUDHAH ROLL ON adalah parfum dengan aroma segar dan lembut, menghadirkan wangi alami yang tahan lama. Dibuat dengan bahan-bahan berkualitas tinggi, ideal untuk memberikan sensasi wewangian yang menyegarkan.";
            } else if (title.includes("KISWAH ROLL ON")) {
                description = "KISWAH ROLL ON adalah parfum dengan aroma kayu elegan yang mewah dan tahan lama. Dibuat dengan bahan berkualitas tinggi, memberikan pengalaman wewangian yang eksklusif.";
            ...
            } else if (title.includes("Mia Premium Fragrance")) {
                description = "";
            }
        
            console.log("📜 Description:", description); // Debugging deskripsi
            ...
            // Pastikan elemen description ditemukan sebelum mengisinya
            const descriptionElement = document.getElementById("popupDescription");
            if (descriptionElement) {
                descriptionElement.innerHTML = description; // Menggunakan innerHTML untuk mendukung HTML dalam deskripsi
            } else {
